            ...
            <div className="h-full relative md:block hidden">
                {data.map((e, i) => (
                    <div key={i} className="relative">
                        <div className="relative  md:h-[100vh] h-[80vh] bg-white   ">
                                    ...
                                    <div className="space-y-2 col-span-3 ">
                                        <div className="flex space-x-2 px-1">
                                            ...
                                            <h3 className="text-lg text-black  ">
                                                Taste The Flavor Of Cappuccino
                                                With Our Creative Digital
                                                Brilliance
                                            </h3>
                                        </div>
                                        <motion.h2
                                            ...
                                            animate="animate"
                                        >
                                            Let&apos;s Brew Creativity Together:
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex space-x-2 px-1">
                                            <h3 className="text-base text-white pt-10 ">
                                                Taking on the Charge in
                                                Innovative Digital Marketing
                                                Strategies for dubai and Beyond
                                            </h3>
                                        </div>
                                        <h2
                                            ...
                                            animate="animate"
                                        >
                                            Changing Your Digital Presence with
